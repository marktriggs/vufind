...
class SearchObject_SolrAuth extends SearchObject_Base
{
    ...
    public function initAuthorityRecommendationSearch($lookfor)
    {
        ...
        // have been retrieved by a search of the biblio core, i.e. it only returns
        // results where $lookfor IS found in in the "Heading" search and IS NOT found
        // in the "MainHeading" search defined in /web/conf/authsearchspecs.yaml
        $group1 = array();
