<?php
/**
 * AJAX handler for Search module
 *
 * PHP version 5
 *
    ...
    public function getItemStatuses()
    {
        ...
        foreach ($result as $record) {
            ...
            if (count($record)) {
                ...
                $callNumber = $this->_pickValue($callNumbers,
                ...
                $location = $this->_pickValue($locations,
        ...
        foreach ($missingIds as $missingId => $junk) {
            ...
            echo '   <location>' . htmlspecialchars(translate('Unknown')) . '</location>';
