        ...
        <div class="yui-g first" style="background-color:#EEE;">
          ...
          <div class="yui-u" id="browse2">
            ...
            <ul class="browse" id="list2">
              ...
              {if $topicEnabled}<li><a href="{$url}/Browse/Genre" onClick="highlightBrowseLink('list2', this); LoadSubject('topic_facet', 'list3', 'genre_facet'); return false">{translate text="By Topic"}</a></li>{/if}
              {if $regionEnabled}<li><a href="{$url}/Browse/Genre" onClick="highlightBrowseLink('list2', this); LoadSubject('geographic_facet', 'list3', 'genre_facet'); return false">{translate text="By Region"}</a></li>{/if}
              {if $eraEnabled}<li><a href="{$url}/Browse/Genre" onClick="highlightBrowseLink('list2', this); LoadSubject('era_facet', 'list3', 'genre_facet'); return false">{translate text="By Era"}</a></li>{/if}
            </ul>
            </div>
          </div>
        </div>
