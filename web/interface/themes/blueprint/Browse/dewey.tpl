...
<div id="list2container" class="span-5 browseNav">
  ...
  {foreach from=$defaultList item=area}
    <li><a href="" title="&quot;{$area.0|escape}&quot;" class="loadOptions query_field:dewey-hundreds facet_field:dewey-tens next_query_field:dewey-ones target:list3container next_target:list4container">{$area.0|escape} ({$area.1})</a></li>
  {/foreach}  
  </ul>
</div>
