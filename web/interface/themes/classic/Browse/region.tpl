        ...
        <div class="yui-g first">
          ...
          <div class="yui-u" id="browse2">
            ...
            <ul class="browse" id="list2">
              ...
              {if $topicEnabled}<li><a href="{$url}/Browse/Region" onClick="highlightBrowseLink('list2', this); LoadSubject('topic_facet', 'list3', 'geographic_facet'); return false">{translate text="By Topic"}</a></li>{/if}
              {if $genreEnabled}<li><a href="{$url}/Browse/Region" onClick="highlightBrowseLink('list2', this); LoadSubject('genre_facet', 'list3', 'geographic_facet'); return false">{translate text="By Genre"}</a></li>{/if}
              {if $eraEnabled}<li><a href="{$url}/Browse/Region" onClick="highlightBrowseLink('list2', this); LoadSubject('era_facet', 'list3', 'geographic_facet'); return false">{translate text="By Era"}</a></li>{/if}
            </ul>
            </div>
          </div>
        </div>
