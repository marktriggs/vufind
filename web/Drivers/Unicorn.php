...
class Unicorn implements DriverInterface
{
    ...
    */
    ...
    /**
     * Find a patron in the Unicorn/Symphony user database matching given username/password.
     * @param string $username user id
     * @param string $password user password/pin
     * @return array associative array of patron data or NULL if no matching user found
     */
     ...
     * @param string $cancel
     * @param string $expire
     * @param string $pickupLib
     * @param string $suspend
     * @param string $unsuspend
